param(
    ...
    [string[]]$LocalPayloadPaths = @(
        ...
        "..\componentes_cliente\PROTEGER_MATERIALES_SALA.ps1",
        "..\componentes_cliente\CREAR_CARPETA_ENTREGA_SALA.ps1"
    )
)
...
$report = Join-Path $reportsDir ("install_admin_bridge_" + $timestamp + ".csv")
