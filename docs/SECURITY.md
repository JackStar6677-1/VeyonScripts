...
- Topologias reales como `config/veyon_topology.local.json`.

## Donde dejar ejemplos

Usa `examples/` para mostrar formatos sin exponer datos reales. Los ejemplos deben usar rangos reservados para documentacion (`192.0.2.0/24`, `198.51.100.0/24`, `203.0.113.0/24`) y MACs ficticias como `02-00-00-00-00-01`.
